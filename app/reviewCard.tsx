...
export default function ReviewCard(props: {
    ...
    return (
        <div className={styles.reviewCardCont} style={{ borderRadius: props.carWidth * 0.07, WebkitBorderRadius: props.carWidth * 0.07, padding: props.carWidth * 0.04, margin: props.carWidth * 0.01, WebkitAppearance: 'none'}}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: props.carWidth * 0.03 }}>
                <div style={{display: 'flex', width: '80%'}}>
                    <div className={styles.reviewImage}>
                        <Image src={props.icon} alt='review Icon' fill style={{ objectFit: 'contain', borderRadius: '100%', WebkitBorderRadius: '100%', WebkitAppearance: 'none' }}></Image>
                    </div>
